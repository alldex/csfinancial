...
class AffiliateWP_Custom_Affiliate_Slugs_Admin {
	...
	/**
	 * Save the custom affiliate slug when the affiliate is added via the admin
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Add new "Custom Slug" column header to the affiliate's exported .csv file
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Add affiliate's custom slug to the exported affiliate's .csv file
	 *
	 * @since 1.0.0
	 */
    ...
    /**
     * Add custom slug option to the referral format select menu
	 *
	 * @since 1.0.0
     */
