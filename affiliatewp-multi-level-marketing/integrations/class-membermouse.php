...
class AffiliateWP_MLM_Membermouse extends AffiliateWP_MLM_Base {
	...
	*/
	...
	public function process_referral( $referral_id, $data ) {
		...
		if ( ! $integrations['membermouse'] ) {
			return; // MLM integration for MemberMouse is disabled 
		}
		
		$referral = affiliate_wp()->referrals->get_by( 'referral_id', $referral_id, $this->context );
		$referral_type = 'direct';
		$referral->custom = maybe_unserialize( $referral->custom );
